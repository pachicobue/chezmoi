...
require("lazy").setup({
  ...
  {                         -- Useful plugin to show you pending keybinds.
    ...
    config = function()     -- This is the function that runs, AFTER loading
      ...
      vim.keymap.set("n", "<leader>bs", "<Cmd>:w<CR>", { desc = "Buffer [S]ave" })
      vim.keymap.set("n", "<leader>fd", "<Cmd>:bd<CR>", { desc = "File [D]elete" })
      vim.keymap.set("n", "<leader>fs", "<Cmd>:w<CR>", { desc = "File [S]ave" })
    end,
  },
  ...
  {   -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>ht", builtin.help_tags, { desc = "Help [T]ag" })
      vim.keymap.set("n", "<leader>hk", builtin.keymaps, { desc = "Help [K]eymaps" })
      vim.keymap.set("n", "<leader>ff", builtin.git_files, { desc = "File [F]iles" })
      vim.keymap.set("n", "<leader>fr", builtin.oldfiles, { desc = "File [R]ecents" })
      ...
      vim.keymap.set("n", "<leader>bb", builtin.buffers, { desc = "Buffer [B]uffers" })

      -- Shortcut for searching your Neovim configuration files
      vim.keymap.set("n", "<leader>on", function()
        builtin.find_files({ cwd = vim.fn.stdpath("config") })
      end, { desc = "Open [N]eovim Config" })
    end,
  },
